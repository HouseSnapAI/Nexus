    ...
    for record in event['Records']:
        try:
            ...
            try:
                ...
                update_flags(report_id, "KeyError: Missing key in body.")
                continue
            ...
            try:
                ...
                update_flags(report_id, "KeyError: Missing key in listing.")
                continue
            ...
            update_flags(report_id, "General error processing record.")
